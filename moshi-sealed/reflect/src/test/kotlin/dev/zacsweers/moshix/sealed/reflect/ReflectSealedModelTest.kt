...
/** Legal-model behavior of the kotlin-reflect entry point, checked against the shared fixtures. */
class ReflectLegalSealedModelTest {
...
class ReflectInvalidSealedModelTest(private val fixture: InvalidSealedFixture) {
  private val moshi: Moshi =
    Moshi.Builder()
      .add(MoshiSealedJsonAdapterFactory())
      .addLast(KotlinJsonAdapterFactory())
